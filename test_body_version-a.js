					...
					<div class="wow fadeIn bbackg"> 
							 ...
							 <div class="container">
							  ...
							  <div class="section-header" style="padding-top:120px;">
                                ...
                                <br><br>
                              <h3 class="underline blink">현재 페이지에서만 드리는<br>특별한 혜택이 있습니다!</h3><br><br>

								 <h3  class="textleft wow fadeInUp">갱년기 자꾸만 늘어나는 뱃살<br>너무 고민 많으시죠?</h3>
                                 <div class="about-content wow fadeIn" style="border:1px solid #c7b583;padding:0 10px 7px 0;margin:0px 0 30px 0;">
                                 <h3 style="margin-top:20px">갱년기 뱃살의<br>원인과 위험성</h3>
                 
                                 <p class="questm wow fadeIn" >
                                 여성호르몬, 성장호르몬의 감소로<br>
                                 <b><u class="underline">체지방 분해 기능 & 대사량 감소</u></b><br> 
                                 <b>↓</b><br>
                                 체지방이 뱃살에 집중적으로 누적<br><br>
                                 체지방 속의 염증 물질이<br>
                                 <b><u class="underline ">심혈관, 골다공증, 치매의 원인이 되며<br>
                                 폐경을 촉진시키는 주요 요인이 됨</u></b>
                                 </p>
								...
								<!--  <p style="text-align:left;margin-bottom:30px" class="textleft questm wow fadeIn">
								  ...
								  <img src="./weight.jpg" style="width:100%;max-width:400px;" alt="" />
								 ...
								 <br>
								  ...
								  <div class="container">
                                    ...
                                    <br>
									  <h3>갱년기의 뱃살만큼은<br>절대 방치해서는 안됩니다.</h3>

                                      <div class="about-content wow fadeIn" style="border:1px solid #c7b583;padding:0 10px 7px 0;margin:0px 0 30px 0;">
                                      <h3 style="margin-top:20px">그렇다고 굶어서 빼려 한다면?</h3>
                      
                                      <p class="questm wow fadeIn" >
                                    
                                      <b>갱년기 시기 영양소 부족은<br> 
                                      <b>↓</b><br>
                                      <u class="underline">근육과 골밀도를 빠르게 감소</u><br><br>
                                      살 찌는 체질을 만들고<br>
                                      <b><u class="underline ">골다공증과 당뇨를 불러 일으키는<br>
                                      안좋은 원인이 될 수 있습니다.</u></b>
                                      </p>
                                    
                                      <img src="./bone.png" style="width:100%;max-width:300px;margin-bottom:20px; alt="" />
                                 
                                      <br>
                                    
                                    </div>
                                    <h3  class="textleft wow fadeInUp" style="margin-top:50px;">갱년기 뱃살 고민<br>건강하게 해결하고 싶다면?</h3>
                                    ...
                                    <div class="container" style="max-width:1200px;">
                                      <div class="row counters">
                                        ...
                                        <div class="col-12 col-md-4 mgb20 text-center">
                                          <span data-toggle="counter-up">50,000</span><span style="font-weight:bold">명</span>
                                          <p>누적상담</p>
                                          <img src="./bottom_laurel.png" style="width:100%;position:relative;margin: -67px 0 0 0;max-width:200px;min-width:110px">	
                                        </div>
                                    ...
                                    <div class="container">
                                       <div class="section-header">
                                        ...
                                        <h3 style="text-align:center" class="textleft">운동 부담 없이 건강하게!<br>하루 2알로 시작하는<br><br>갱년기 뱃살 다이어트<br> 컷앤컷 1:1 개인 맞춤 플랜</h3>
                                        <img src="./cutncut-intro.png" style="width:100%;max-width:500px;margin-bottom:30px">
                                        <p class="textleft questm">
                                        갱년기 달라진 체질에 맞게<br>여러분의 뱃살 감량을<br>책임지고 관리해 드립니다</p>
                                      </div>
                                      ...
                                      <div class="col-lg-5 col-md-5 wow fadeInUp">
                                        ...
                                        <p class="img_text wow fadeInUp">1. 체형, 체질 분석</p>
                               ...
                               <section id="team" class="section-bg wow fadeIn" style="margin-top: 30px;">
                                 <div class="container">
                                   ...
                                   <div class="row">
                                    ...
                                    <br><Br>
                               <h3>현재 페이지에서만 드리는 특별한 혜택!</h3>
                                    <p class="textleft questm">
									 사랑하는 가족을 돌보느라<br>갱년기 시기 달라지는 몸과 건강을<br>돌볼 겨를이 없는<br>어머님을 위한 특별 이벤트!<br><br>
                                     갱년기 시기 안빠지는 원인과<br>달라진 체질에 맞는<br>전문가 1:1 상담을 무료 제공<br><br>
			...
			<div class="row">
				...
				<span>주소: 서울한정시 광진구 능동로 40길 10-3</span>
							  ...
							  <center><h1><span class="questm ft-white">성함</span></h1></center>
										 ...
										 <br><br>
										  ...
										  <center><br><div class=" alert_msg">
										   ...
										   <span class="tip-text ">갱년기 감량에 도움될 수 있게<br>친절히 안내드리겠습니다.</span><br><br>	
										   </div>
						...
						<!-- <img src="./mirror.jpg" class="bg-img br50" style="min-height:950px;max-height:1050px"> -->
						 ...
						 <div class="container">
							<div class="section-header">
							 <h3 style="text-align:center" class="textleft">갱년기 다이어트에 특화된<br>올바른 감량 방식을 찾아주는<br> 컷앤컷 1:1 개인 맞춤 플랜</h3>
							 <p class="textleft questm">
